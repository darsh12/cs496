 ...
 */
class Version20180419231852 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE user_util_cards ADD card_defeats INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE user_stat ADD times_defended INT NOT NULL');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE user_stat DROP times_defended');
        $this->addSql('ALTER TABLE user_util_cards DROP card_defeats');
    }
}
