 ...
 */
class Version20180322035212 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE achievement (id INT AUTO_INCREMENT NOT NULL, description VARCHAR(255) NOT NULL, reward_id INT NOT NULL, type VARCHAR(255) NOT NULL, count_value INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE battle (id INT AUTO_INCREMENT NOT NULL, winner_id INT NOT NULL, battle_datetime DATETIME NOT NULL, defend_char_deck_id INT NOT NULL, defend_util_deck_id INT NOT NULL, battle_report VARCHAR(255) NOT NULL, request_id INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE battle_request (id INT AUTO_INCREMENT NOT NULL, attacker_id INT NOT NULL, defender_id INT NOT NULL, datetime DATETIME NOT NULL, attack_char_deck_id INT NOT NULL, attack_util_deck_id INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE char_card (id INT AUTO_INCREMENT NOT NULL, char_name VARCHAR(255) NOT NULL, char_type VARCHAR(255) NOT NULL, char_class VARCHAR(255) NOT NULL, char_tier VARCHAR(255) NOT NULL, char_stat_id INT NOT NULL, avatar_id INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE custom_card (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, type INT NOT NULL, card_stat_id INT NOT NULL, votes INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user_achievement (user_id INT NOT NULL, achievement_id INT NOT NULL, PRIMARY KEY(user_id, achievement_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user_char_card (user_id INT NOT NULL, char_card_id INT NOT NULL, card_kills INT NOT NULL, card_deaths INT NOT NULL, card_count INT NOT NULL, card_uses INT NOT NULL, PRIMARY KEY(user_id, char_card_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user_stat (user_id INT NOT NULL, user_rank INT NOT NULL, user_level TIME NOT NULL, play_time INT NOT NULL, matches_won INT NOT NULL, matches_lost NUMERIC(10, 0) NOT NULL, win_loss_ratio INT NOT NULL, favorite_card INT NOT NULL, times_attacked INT NOT NULL, times_defended INT NOT NULL, best_win_battle INT NOT NULL, worst_lost_battle INT NOT NULL, most_defeated_card INT NOT NULL, PRIMARY KEY(user_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user_util_card (user_id INT NOT NULL, util_card_id INT NOT NULL, card_count INT NOT NULL, card_uses INT NOT NULL, PRIMARY KEY(user_id, util_card_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE util_card (id INT AUTO_INCREMENT NOT NULL, util_name VARCHAR(255) NOT NULL, util_type VARCHAR(255) NOT NULL, util_tier VARCHAR(255) NOT NULL, avatar_id INT NOT NULL, attack_effect_id INT NOT NULL, defense_effect_id INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE util_deck (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, card1_id INT NOT NULL, card2_id INT NOT NULL, card3_id INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE achievements (id INT AUTO_INCREMENT NOT NULL, description VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, reward_id INT NOT NULL, type VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, count_value INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE avatars (id INT AUTO_INCREMENT NOT NULL, image_path VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE battles (id INT AUTO_INCREMENT NOT NULL, winner_id INT NOT NULL, battle_datetime DATETIME NOT NULL, defend_char_deck_id INT NOT NULL, defend_util_deck_id INT NOT NULL, battle_report VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, request_id INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE char_cards (id INT AUTO_INCREMENT NOT NULL, char_name VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, char_type VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, char_class VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, char_tier VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, char_stat_id INT NOT NULL, avatar_id INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE rewards (id INT AUTO_INCREMENT NOT NULL, type VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, value INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE util_cards (id INT AUTO_INCREMENT NOT NULL, util_name VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, util_type VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, util_tier VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, avatar_id INT NOT NULL, attack_effect_id INT NOT NULL, defense_effect_id INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
