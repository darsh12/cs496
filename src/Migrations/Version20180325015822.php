 ...
 */
class Version20180325015822 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE user_char_card (char_card_id INT NOT NULL, user_id INT NOT NULL, card_kills INT NOT NULL, card_deaths INT NOT NULL, card_count INT NOT NULL, card_uses INT NOT NULL, INDEX IDX_66316B6B75D82FC3 (char_card_id), INDEX IDX_66316B6BA76ED395 (user_id), PRIMARY KEY(char_card_id, user_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
