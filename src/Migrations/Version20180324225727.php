 ...
 */
class Version20180324225727 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE char_deck (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, card1_id INT DEFAULT NULL, card2_id INT DEFAULT NULL, card3_id INT DEFAULT NULL, card4_id INT DEFAULT NULL, card5_id INT DEFAULT NULL, INDEX IDX_3F69486BA76ED395 (user_id), INDEX IDX_3F69486BED48C1C1 (card1_id), INDEX IDX_3F69486BFFFD6E2F (card2_id), INDEX IDX_3F69486B4741094A (card3_id), INDEX IDX_3F69486BDA9631F3 (card4_id), INDEX IDX_3F69486B622A5696 (card5_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user_char_card (user_id INT NOT NULL, char_card_id INT NOT NULL, card_kills INT NOT NULL, card_deaths INT NOT NULL, card_count INT NOT NULL, card_uses INT NOT NULL, INDEX IDX_66316B6BA76ED395 (user_id), INDEX IDX_66316B6B75D82FC3 (char_card_id), PRIMARY KEY(user_id, char_card_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE util_deck (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, card1_id INT DEFAULT NULL, card2_id INT DEFAULT NULL, card3_id INT DEFAULT NULL, INDEX IDX_C1947A78A76ED395 (user_id), INDEX IDX_C1947A78ED48C1C1 (card1_id), INDEX IDX_C1947A78FFFD6E2F (card2_id), INDEX IDX_C1947A784741094A (card3_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE char_deck ADD CONSTRAINT FK_3F69486BED48C1C1 FOREIGN KEY (card1_id) REFERENCES char_card (id)');
        $this->addSql('ALTER TABLE char_deck ADD CONSTRAINT FK_3F69486BFFFD6E2F FOREIGN KEY (card2_id) REFERENCES char_card (id)');
        $this->addSql('ALTER TABLE char_deck ADD CONSTRAINT FK_3F69486B4741094A FOREIGN KEY (card3_id) REFERENCES char_card (id)');
        $this->addSql('ALTER TABLE char_deck ADD CONSTRAINT FK_3F69486BDA9631F3 FOREIGN KEY (card4_id) REFERENCES char_card (id)');
        $this->addSql('ALTER TABLE char_deck ADD CONSTRAINT FK_3F69486B622A5696 FOREIGN KEY (card5_id) REFERENCES char_card (id)');
        ...
        $this->addSql('ALTER TABLE user_stat ADD CONSTRAINT FK_5A39B3E8F81281EC FOREIGN KEY (favorite_card) REFERENCES user_char_card (char_card_id)');
        ...
        $this->addSql('ALTER TABLE user_stat ADD CONSTRAINT FK_5A39B3E898E368AB FOREIGN KEY (most_defeated_card) REFERENCES user_char_card (char_card_id)');
        ...
        $this->addSql('ALTER TABLE util_deck ADD CONSTRAINT FK_C1947A78ED48C1C1 FOREIGN KEY (card1_id) REFERENCES util_card (id)');
        $this->addSql('ALTER TABLE util_deck ADD CONSTRAINT FK_C1947A78FFFD6E2F FOREIGN KEY (card2_id) REFERENCES util_card (id)');
        $this->addSql('ALTER TABLE util_deck ADD CONSTRAINT FK_C1947A784741094A FOREIGN KEY (card3_id) REFERENCES util_card (id)');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE char_deck DROP FOREIGN KEY FK_3F69486BED48C1C1');
        $this->addSql('ALTER TABLE char_deck DROP FOREIGN KEY FK_3F69486BFFFD6E2F');
        $this->addSql('ALTER TABLE char_deck DROP FOREIGN KEY FK_3F69486B4741094A');
        $this->addSql('ALTER TABLE char_deck DROP FOREIGN KEY FK_3F69486BDA9631F3');
        $this->addSql('ALTER TABLE char_deck DROP FOREIGN KEY FK_3F69486B622A5696');
        ...
        $this->addSql('ALTER TABLE util_deck DROP FOREIGN KEY FK_C1947A78ED48C1C1');
        $this->addSql('ALTER TABLE util_deck DROP FOREIGN KEY FK_C1947A78FFFD6E2F');
        $this->addSql('ALTER TABLE util_deck DROP FOREIGN KEY FK_C1947A784741094A');
