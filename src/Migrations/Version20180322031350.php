 ...
 */
class Version20180322031350 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE test_table (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, card_hp VARCHAR(255) NOT NULL, card_image VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
