...
/**
 * @ORM\Entity(repositoryClass="App\Repository\DefUtilEffectsRepository")
 */
class DefUtilEffects
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
     * @ORM\Column(type="integer")
     * @ORM\ManyToOne(targetEntity="App\Entity\UtilCards", inversedBy="defense_effect_id")
