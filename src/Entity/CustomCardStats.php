...
/**
 * @ORM\Entity(repositoryClass="App\Repository\CustomCardStatsRepository")
 */
class CustomCardStats
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
     * @ORM\Column(type="integer")
     * @ORM\ManyToOne(targetEntity="App\Entity\CustomCards", inversedBy="card_stat_id")
