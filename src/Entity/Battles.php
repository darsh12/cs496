...
/**
 * @ORM\Entity(repositoryClass="App\Repository\BattlesRepository")
 */
class Battles
{
    /**
     ...
     * @ORM\ManyToOne(targetEntity="App\Entity\UserStats", inversedBy="best_win_battle")
     * @ORM\ManyToOne(targetEntity="App\Entity\UserStats", inversedBy="worst_lost_battle")
    ...
    /**
     * @ORM\Column(type="integer")
     * ORM\OneToMany(targetEntity="App\Entity\BattleRequests", mappedBy="id")
     */
    private $request_id;
