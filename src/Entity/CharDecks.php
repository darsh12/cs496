...
/**
 * @ORM\Entity(repositoryClass="App\Repository\CharDecksRepository")
 * @ORM\Entity
 * @ORM\Table(name="char_decks")
 */
class CharDecks
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
     * @ORM\Column(type="integer")      // question: how to express integer length limit?
     * @ORM\ManyToOne(targetEntity="App\Entity\Battles", inversedBy="defend_char_deck_id")
     * @ORM\ManyToOne(targetEntity="App\Entity\BattleRequests", inversedBy="attack_char_deck_id")
    ...
    /**
     * @ORM\Column(type="integer")
     * @ORM\OneToMany(targetEntity="App\Entity\CharCards", mappedBy="id")
     */
    private $card1_id;
