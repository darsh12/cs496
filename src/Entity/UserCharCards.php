...
class UserCharCards
{
     ...
     * @ORM\ManyToOne(targetEntity="App\Entity\UserStats", inversedBy="favorite_card")
     * @ORM\ManyToOne(targetEntity="App\Entity\UserStats", inversedBy="most_defeated_card")
